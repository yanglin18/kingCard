      ...
      <div class="form_content">
        ...
        <div class="content_row">
          ...
          <div class="right_span">
            ...
            <span @click="showChoose"
              :class="select_place == '' ? '' : 'selected'">{{select_place}}</span>
          </div>
        </div>
        <div class="content_row">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      conform()
      {
        let Url = "https://bdsimcard.houselai.com/1/?itemcode=" + this.form.itemcode + "&adid=" + this.adid + "&clickid=" + this.clickid + "&creativeid=" + this.creativeid + "&creativetype=" + this.creativetype + ""
        this.$axios({
          method: "get",
