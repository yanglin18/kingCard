<template>
  <div class="mainPage">
    ...
    <div class="content">
      ...
      <div class="top_title">
        已选择<span class="selectIndex">{{ card }}</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    getId() {
      ...
      if (this.active === 1 || this.active === 4 || this.active === 7) {
        this.form.goodsId = "981610241535";
        this.card = "腾讯大王卡";
      }
      if (this.active === 8 || this.active === 5 || this.active === 2) {
        this.form.goodsId = "981802085690";
        this.card = "腾讯地王卡";
      }
      if (this.active === 6 || this.active === 3 || this.active === 0) {
        this.form.goodsId = "981702278573";
        this.card = "腾讯天王卡";
      }
    },
    toUserAgreement() {
