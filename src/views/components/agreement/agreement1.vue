<template>
  <div class="content">
    ...
    <div class="text">
      为向客户提供优质、个性化的服务，包括但不限于提供通信服务、保障通信服务安全、改善服务质量、推介个性化产品等，我公司将遵循合法、正当、必要的原则，按照法律法规规定和
      /或协议约定使用留存客户个人信息，并妥善保管，严格保密，依法保护客户个人信息，非因下列事由，不对外泄露客户个人信息：
    </div>
    <div>(a)事先获得客户的明确授权；</div>
    <div>(b)根据有关的法律法规要求；</div>
    <div>(c)按照相关司法机关和/或政府主管部门的要求；</div>
